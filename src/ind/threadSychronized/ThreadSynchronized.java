...
public class ThreadSynchronized {
    ...
    @Test
    public void runAtomOnThis() throws InterruptedException {
        AtomActionOnThis notAtomAction = new AtomActionOnThis("zhangsan");
 ...
 * synchronized 用在了共有方法上面
 */
class AtomActionOnThis implements Runnable {
    private String name;
    private int i;

    public AtomActionOnThis(String name) {
        this.name = name;
    }
